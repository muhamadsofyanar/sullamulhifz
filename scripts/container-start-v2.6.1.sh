...
echo "=== Sullamul Hifz v2.6.1 Mushaf Line Engine startup ==="
...
if [ "${MUSHAF_LINE_AUTO_SYNC:-true}" = "true" ]; then
    ...
    (
        ...
        php artisan sullam:ensure-mushaf-lines || echo "PERINGATAN: Mushaf Line belum 604/604; halaman yang dibuka guru tetap dicoba on-demand."

...
echo "=== Sullamul Hifz v1.6.1 container startup ==="
...
if [ "${QURAN_AUDIO_AUTO_SYNC:-true}" = "true" ]; then
    echo "Sinkronisasi Quran Learning dijalankan di latar belakang agar website segera aktif."
    (
    ...
    echo "QURAN_AUDIO_AUTO_SYNC=false: sinkronisasi audio otomatis dilewati."
fi

...
<a href="{{ route('quran-practice.index') }}" class="family-action primary"><x-icon name="audio" size="30"/><strong>Latihan Al-Qur’an</strong><span>Putar target atau murajaah</span></a>
<a href="{{ route('academy.index') }}" class="family-action"><x-icon name="academic" size="30"/><strong>Parent Academy</strong><span>Belajar mendampingi anak</span></a>

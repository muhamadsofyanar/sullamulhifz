...
Roadmap resmi terdiri dari 10 fase. Detail definisi Fase 4 ada di `ROADMAP-10-PHASES-V2.6.0.md`.
...
- Fase 4 / v4.5.0 — Personal 2.0: **verified**.
- Fase 5 / v4.6.0 — Ustadz Privat: **implementation completed in v4.8.0; production relationship flow telah diuji, verifikasi penuh semua skenario tetap bertahap**.
- Fase 6 / v4.7.0 — Institution Suite: **implementation completed in v4.8.0**.
- Fase 7 / v4.8.0 — Family & Parent Portal: **implementation completed in v4.8.0**.
- Fase 8 / v4.9.0 — Learning & Academy Integration: **verifier dan smoke test Ruang Belajar produksi lulus**.
- Fase 9 / v5.0.0 — Business, Payment & Integrations: **implemented in consolidated v5.3.0; production validation pending**.
- Fase 10 / v5.1.0 — SaaS Production Readiness: **implemented in consolidated v5.3.0; operator evidence backup/restore/load test pending until actually performed**.

### Post-roadmap Product Extension

Fase 11–12 adalah perluasan setelah roadmap Product Expansion 10 fase; keduanya tidak mengubah sejarah roadmap resmi lama.
...
Asal file dan status tiap fase dicatat di `docs/PHASE-REGISTRY.md` serta `PHASE-MANIFEST.json`.

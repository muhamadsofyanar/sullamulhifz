...
Rilis kandidat: **v6.1.0 — Transparansi Infak, Operasional Cepat & UI/UX Mobile**.
...
- seluruh fungsi inti gratis tanpa subscription; infak sukarela memiliki alokasi berversi, ledger append-only, realisasi maker-checker, bukti tersamarkan, dan laporan dampak tanpa mengubah hak akses.
- UI/UX v6.1: navigasi berkelompok, antrean operasional, prioritas Murāja‘ah/koreksi, status konsisten, serta workspace ponsel yang lebih ringkas.
...
2. [`UPGRADE-V6.1.0.md`](UPGRADE-V6.1.0.md)
3. [`DEPLOY-QUICK-V6.1.0.txt`](DEPLOY-QUICK-V6.1.0.txt)
...
Upgrade v6.1.0 bersifat additive terhadap v6.0.0. Data lembaga, pembelajaran, media, workspace Personal, hubungan Ustadz/Keluarga, ledger komunikasi, transaksi infak lama, serta histori paket/invoice tetap dipertahankan. Form setoran rinci lama juga tetap tersedia untuk asesmen dan kasus khusus.

...
{
    use SoftDeletes;
    protected $fillable = ['institution_id','academic_year_id','class_id','learning_group_id','program_id','teacher_assignment_id','day_of_week','start_time','end_time','location','effective_from','effective_until','status'];

...
{
    protected $fillable = ['institution_id','meeting_id','student_id','teacher_id','material_text','surah_id','start_verse','end_verse','overall_status','focus_categories','teacher_notes','follow_up'];

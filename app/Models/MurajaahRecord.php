...
{
    protected $fillable = ['institution_id','meeting_id','learning_cycle_id','review_plan_id','student_id','teacher_id','murajaah_type','surah_id','start_verse','end_verse','result','daily_decision','short_note','submission_key','strength_status','assistance_level','prompt_count','self_correction_count','next_review_date','review_recommendation','teacher_notes','recorded_at'];

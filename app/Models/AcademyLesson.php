...
{
    protected $fillable = ['academy_module_id','title','slug','lesson_type','summary','body','media_url','duration_minutes','sort_order','requires_action','status'];
    protected function casts(): array { return ['requires_action' => 'boolean', 'duration_minutes' => 'integer']; }

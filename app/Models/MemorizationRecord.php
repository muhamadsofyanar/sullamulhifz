...
{
    protected $fillable = ['institution_id','meeting_id','memorization_target_id','learning_cycle_id','student_id','teacher_id','marhalah_type_id','record_type','delivery_mode','surah_id','start_verse','end_verse','result','fluency_status','tajwid_status','error_count','prompt_count','self_correction_count','assistance_level','follow_up','review_recommendation','next_review_date','teacher_notes','recorded_at'];

...
class FridayDevelopmentSession extends Model
{
    ...
    protected $fillable = [
        ...
        'worksheet_path', 'worksheet_original_name', 'worksheet_media_id', 'family_response_enabled', 'status', 'published_at',
    ];
    ...
    public function targets(): HasMany { return $this->hasMany(FridaySessionTarget::class); }
    public function worksheetMedia(): BelongsTo { return $this->belongsTo(MediaAsset::class, 'worksheet_media_id'); }
}

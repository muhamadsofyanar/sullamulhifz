...
class QuranJourneyV260Seeder extends Seeder
{
    public function run(): void
    {
        ...
        $checks = [
            ...
            ['phase4_all_marhalah_portions','Roadmap Fase 4','Seluruh porsi Marhalah diuji end-to-end: Āyah ≥1 ayat, Tsalātsiyyah 3 baris, Khamsiyyah 5 baris, Niṣfiyyah ½ halaman, Ṣafḥah 1 halaman, dan Ṣafḥatayn 2 halaman; target Tahfizh terhubung dan batas Juz tidak dilanggar.'],
